...
function generateContent(data) {
  ...
  const stopwords = new Set([
    ...
    'went', 'said', 'going', 'come', 'much', 'omitted', 'media', 'link', 'image', 'video', 'quote', 'reply', 'null', 'www', 'HTMLOutputElement', 'HTMLOptionsCollection', 'twitter', 'edited', 'https', 'http', 'message', '//twitter', '<this', 's=46',
    // Español
